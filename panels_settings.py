"""Settings panel for Kubecost Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__kubecost_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=kubecost_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_kubecost"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Kubecost Settings & Accounts", level=2),
