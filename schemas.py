"""Pydantic schemas for Kubecost Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Kubecost.")
    api_key: str = Field(description="FinOps API Key")
    base_url: str = Field(default="https://api.kubecost.com/v1", description="Kubecost API base URL.")
...
class GetCostRecordParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    costrecord_id: str = Field(description="Kubecost CostRecord ID.")
